...
|-----------|---------------|
| HTML5 | Sayfa yapısı |
| CSS3 | Tasarım, animasyonlar, grid layout |
| Vanilla JavaScript | Etkileşim, canvas, scroll efektleri |
| Google Fonts | Bebas Neue & DM Sans tipografisi |
...
```
WashNova/
├── index.html                    # Main HTML file (all CSS and JS included)
├── img/
│   ├── main-system.jpeg
│   ├── background-1.jpeg
│   ├── background-2.png
